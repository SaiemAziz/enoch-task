      ...
      <CardBody>
        ...
        >
          ...
          <Badge
            ...
            py={1}
            color={"white"}
            borderColor={isAuction ? "#9e420b" : "#45379f"}
          >
        ...
        {/* image  */}
        <Image src={img} borderRadius={"md"} width={"full"} />
        ...
        <Box
          ...
          alignItems={"center"}
        >
          <Text fontStyle={"normal"} fontSize={"xl"} color={"#dbdde0"}>
            {title}
          </Text>
          <Box as={"div"} display={"flex"} alignItems={"center"}>
            ...
            <Text fontSize={"xl"} color={liked ? "#c7ccd0" : "#474763"}>
              {totalLiked}
            </Text>
          </Box>
        </Box>
        <Text fontStyle={"normal"} fontSize="" color={"#3f7bb6"}>
          {seller}
        </Text>
        ...
        >
          ...
          >
            ...
            <br />
            <Text fontStyle={"normal"} fontSize={"xl"} color={"#f3f4f5"}>
              ${amount}
            </Text>
            {!isAuction && (
              <Badge
          ...
          >
            <Text
              ...
              color={"#83add5"}
            >
              {isAuction ? "AUCTION" : "FLASH DEAL"} ENDS IN
            </Text>
        ...
        >
          {!isAuction && (
            <Button
              ...
              color={"#e9eaeb"}
              borderRadius={"sm"}
              _hover={{ backgroundColor: "blue.700", borderColor: "blue.700" }}
            >
              ADD TO CART
            </Button>
          )}
